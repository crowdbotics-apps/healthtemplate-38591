"""
Django settings for healthtemplate_38591 project.
...
ROOT_URLCONF = 'healthtemplate_38591.urls'
...
WSGI_APPLICATION = 'healthtemplate_38591.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthtemplate_38591 API",
    "DESCRIPTION": "API documentation for healthtemplate_38591 App",
    "VERSION": "v1",
}

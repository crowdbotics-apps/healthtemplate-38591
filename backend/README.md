...
## Project Structure
    ...
    ├── healthtemplate_38591  # Django project configurations
...
1. Clone this repo and `cd healthtemplate_38591`
...
2. Clone this repo and `cd healthtemplate_38591`
